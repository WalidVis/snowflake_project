...
PUT file://objects_statements/notebooks/INGEST_RAW_FILES_INTO_BRONZE_LAYER.ipynb @raw_layer.landingg_internal_stage/staged_notebooks
AUTO_COMPRESS = FALSE;


CREATE OR REPLACE NOTEBOOK BRONZE_LAYER.INGEST_RAW_FILES_INTO_BRONZE_LAYER
  FROM '@raw_layer.landingg_internal_stage/staged_notebooks' 
