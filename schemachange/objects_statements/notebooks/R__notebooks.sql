...
PUT file://objects_statements/notebooks/? @raw_layer.landing_internal_stage/staged_notebooks
AUTO_COMPRESS = FALSE;
...
CREATE OR REPLACE NOTEBOOK SILVER_LAYER.INGEST_INTO_SILVER_LAYER
  ...
  MAIN_FILE = 'INGEST_INTO_SILVER_LAYER.ipynb' 
   COMMENT = 'Notebook to ingest data from bronze tables to silver tables';