...
CREATE OR REPLACE NOTEBOOK SILVER_LAYER.INGEST_FACT_RETAIL_INTO_SILVER
FROM '@raw_layer.landing_internal_stage/staged_notebooks' 
...
ALTER NOTEBOOK SILVER_LAYER.INGEST_INTO_SILVER_LAYER ADD LIVE VERSION FROM LAST;
ALTER NOTEBOOK SILVER_LAYER.INGEST_FACT_RETAIL_INTO_SILVER ADD LIVE VERSION FROM LAST;
