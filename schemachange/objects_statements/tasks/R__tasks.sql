...
create or replace task BRONZE_LAYER."INGEST_PRC_GENERIC_GEOGRAPHY_GOLD"
	warehouse=DEV_WH
	after BRONZE_LAYER.INGEST_PRC_GENERIC_GEOGRAPHY_SILVER
...
ALTER TASK BRONZE_LAYER.ingest_prc_generic_geography_gold RESUME;
...
ALTER TASK BRONZE_LAYER.INGEST_PRC_HOUSE_PRICE_BRZ_JSON SUSPEND;
